<template>
  <div style="z-index: 999">
    <nav class="nav nav--shamso">
      <button class="nav__item nav__item--current" aria-label="Item 1"><span class="nav__item-title">#vanlife</span></button>
      <button class="nav__item" aria-label="Item 2"><span class="nav__item-title">#bohostyle</span></button>
...
export default {
  ...
  methods: {
    ...
    setCurrent(item) {
      ...
      // remove current
      var currentItem = document.querySelector('.nav__item--current')
