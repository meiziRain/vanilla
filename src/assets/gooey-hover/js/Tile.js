...
export default class Tile {
    ...
    constructor($el, scene, duration, fragmentShader) {
        ...
        this.preload(['@/assets/gooey-hover/img/shape.jpg', this.mainImage.dataset.hover, '@/assets/gooey-hover/img/shape.jpg'], () => { this.initTile() })
    ...
    initTile() {
        ...
        console.log(new THREE.Mesh(this.geometry, this.material))
